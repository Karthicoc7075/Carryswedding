      ...
      <div className="footer-metadata">
        <div className="footer-contact">
          ...
          <div className="footer-item">
            ...
            <div className="footer-contact-numbers">
              <a href="tel:8122697732">+91 81226 97732</a>
              <a href="tel:9514441965">+91 95144 41965</a>
              <a href="tel:9514419941">+91 95144 19941</a>
            </div>
          </div>

          <div className="footer-item">
            <img src={MailIcon} alt="Mail icon" />
            <a href="mailto:carysweddingevent@gmail.com" target="_blank" rel="noopener noreferrer">carysweddingevent@gmail.com</a>
          </div>
        </div>
        ...
        <div className="footer-info">
          <div className="footer-socials">
            <a href="https://wa.me/9514419941?text=Hi, I'm interested in your wedding planning services." target="_blank" rel="noopener noreferrer"><img src={WhatsappIcon1} alt="WhatsApp icon" /></a>
            ...
            <a href="mailto:carysweddingevent@gmail.com" target="_blank" rel="noopener noreferrer"><img src={EmailIcon} alt="Mail icon" /></a>
          </div>
          <p>© 2025 Caryswedding. All rights reserved.</p>
        </div>
      </div>
 <div className="circle blow-ripple" >
       <a href="https://wa.me/9514419941?text=Hi, I'm interested in your wedding planning services." target="_blank" rel="noopener noreferrer"><img src={WhatsappIcon} alt="WhatsApp icon" /></a>
      </div>
